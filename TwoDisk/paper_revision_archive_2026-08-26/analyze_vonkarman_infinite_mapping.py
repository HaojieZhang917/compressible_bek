...
Original finite-domain data are read-only; all derived output is written to
``TwoDisk/vonkarman_infinite_mapping``.
"""
...
VK_ROOT = TOOLKIT / "compress" / "BEK" / "Vonkarmen_bone"
OUT = SCRIPT_DIR / "vonkarman_infinite_mapping"
sys.path.insert(0, str(VK_ROOT / "scripts"))
